...
OVERVIEW = \
    f"## Benchmark\n" \
    "This file is automatically generated by a {ACTION_LINK}. " \
    "The latest image for {DH_REPO_LINK} and the official {PYTHON_LINK} " \
    "image are pulled and used to run {PYPERF_LINK}, with the results then " \
    "compared and formatted into this document."
